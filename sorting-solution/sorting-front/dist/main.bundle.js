...
var ResultComponent = (function () {
    ...
    ResultComponent.prototype.addSort = function (inputArray) {
        console.log(this.inputArray);
        console.log(JSON.parse(this.inputArray));
        this.appService.addSort(inputArray)
            .subscribe(function (data) { return inputArray; });
        this.getResults();
    };
